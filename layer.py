...
class Layer():
    ...
    def return_to_higher_level(self, max_lay_achieved, agent, env, attempts_made):
        ...
        elif self.layer_number < agent.FLAGS.layers-1 and attempts_made >= self.time_limit:
            return True
    ...
    def train(self, agent, env, subgoal_test = False):
        ...
        if self.layer_number == 0 and agent.FLAGS.show and agent.FLAGS.subgoals and agent.FLAGS.layers > 1:
        ...
        while True:
            ...
            if agent.FLAGS.verbose:
                ...
                print("\nLevel %d, Attempt %d" % (self.layer_number,attempts_made))
