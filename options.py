...
def parse_options():
    ...
    # --show option will show training
    parser.add_argument(
        '--show',
        action='store_true',
    ...
    # --subgoals will display subgoals
    parser.add_argument(
        '--subgoals',
        action='store_true',
        help='Include to visualize training'
    ...
    # If using pre-trained skills, remaining options are not relevant
    parser.add_argument(
        '--retrain',
        action='store_true',
    ...
    # Set flags to True when skills are fixed
    FLAGS.test = True
